...
var Search = /** @class */ (function (_super) {
    ...
    function Search() {
        ...
        _this.onSelect = function (value) {
            ...
            _this.setState(__assign(__assign({}, _this.state), { history: _this.dataManager.data, value: value }));
        };
    ...
    Search.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classnames_1.default("Search", this.props.className) },
            ...
            React.createElement("div", { className: "SearchHistory" }, this.state.history.map(function (e, i) { return (React.createElement(antd_1.Tag, { className: "SearchHistory-tag", key: e + i, closable: true, onClick: _this.onClickHandle(e), onClose: _this.onCloseHandle(e) }, _this.props.historyRender
                ? _this.props.historyRender(e)
                : e)); }))));
    };
    return Search;
}(React.Component));
