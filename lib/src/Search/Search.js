...
var Search = /** @class */ (function (_super) {
    ...
    Search.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classnames_1.default("Search", this.props.className) },
            React.createElement(antd_1.AutoComplete, __assign({}, this.props, { onSelect: this.onSelect, value: this.props.value ? this.props.value : this.state.value, onChange: this.onChange, className: classnames_1.default("SearchInput", {
