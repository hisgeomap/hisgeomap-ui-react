...
var DragPanel = /** @class */ (function (_super) {
    ...
    function DragPanel() {
        ...
        _this.DragCore = new DragCore(_this.ref, _this.props.direction, _this.props.states, _this.props.defaultState);
        _this.componentDidMount = function () {
            var handle = _this.props.handle
                ? document.querySelector(_this.props.handle)
                : _this.ref.current;
            var trigger = _this.props.trigger
                ? document.querySelector(_this.props.trigger)
                : null;
            if (handle) {
                handle.addEventListener("dragstart", _this.DragCore.onDragStart, true);
                handle.addEventListener("drag", _this.DragCore.onDrag, true);
                handle.addEventListener("dragend", _this.DragCore.onDragStop, true);
                handle.addEventListener("touchstart", _this.DragCore.onTouchStart, true);
                handle.addEventListener("touchmove", _this.DragCore.onTouchMove, true);
                handle.addEventListener("touchend", _this.DragCore.onTouchStop, true);
        ...
        _this.shouldComponentUpdate = function () { return false; };
        return _this;
    }
...
var DragCore = /** @class */ (function () {
    function DragCore(ref, direction, states, defaultState) {
        var _this = this;
            ...
            if (component && _this.dragging && _this.isMainDir) {
                if (_this.isMainDir) {
                    ...
                    if (_this.states.length > 0) {
                        ...
                        _this.curPos.state = _this.findNearestState();
