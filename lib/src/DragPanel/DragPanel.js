...
var DragPanel = /** @class */ (function (_super) {
    ...
    function DragPanel() {
        ...
        _this.componentDidMount = function () {
            ...
            console.log(handle);
            if (handle) {
                handle.addEventListener("dragstart", _this.DragCore.onDragStart);
                handle.addEventListener("drag", _this.DragCore.onDrag);
                handle.addEventListener("dragend", _this.DragCore.onDragStop);
                handle.addEventListener("touchstart", _this.DragCore.onTouchStart);
                handle.addEventListener("touchmove", _this.DragCore.onTouchMove);
                handle.addEventListener("touchend", _this.DragCore.onTouchStop);
